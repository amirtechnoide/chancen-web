      ...
      >
        <div className="w-[92%] mx-auto">
          <div className="relative flex items-center justify-end gap-4">
            ...
            <div className="flex w-full items-center justify-end px-4 gap-4">
              <div>
                <button
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-zinc px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-dark lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${
                    navbarOpen
                    ...
                    {headerLinks.map((menuItem, index) => (
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          <Link
                            href={menuItem.path}
                            className={`flex py-2 hover:text-primary ${
                              !sticky ? `text-white` : "text-white"
                            } lg:mr-0 lg:inline-flex lg:py-6 ${
